...
ElastNetMT —**Elas**tic **Net**works **M**ulti**T**oolkit— is a scientific
...
research. With ElastNetMT, you can streamline the integration of workflows involving
...
ElastNetMT is an open-source project shared under the [MIT
license](https://github.com/uibcdf/elastnetmt/blob/main/LICENSE). This means
