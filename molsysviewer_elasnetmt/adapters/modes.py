...
from elasnetmt.model.anisotropic_network_model import AnisotropicNetworkModel
...
def get_or_build_anm_model(
    ...
    *,
    ...
    if molecular_system is None:
        raise ValueError("A molecular system must be loaded in the view before rendering ElasNetMT modes.")
...
def render_mode_vectors(
    ...
    *,
    ...
    tag = tag or f"elasnetmt:mode:{mode_index}"
